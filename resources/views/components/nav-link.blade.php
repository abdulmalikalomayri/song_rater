...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 dark:border-emerald-300 dark:border-emerald-600 text-sm font-medium leading-5 text-neutral-900 dark:text-neutral-100 focus:outline-none focus:border-emerald-700 transition duration-150 ease-in-out'
